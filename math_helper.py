...
class MathHelper:
    ...
    @staticmethod
    def hyperellipsoid(P, p_val=.95, units=None, show=True, ax=None):
        """
        ...
        if p == 2 or p == 3:
            ...
            if s.size == 2:
                ...
                angles = MathHelper.rotXYZ(R, unit='deg')
            # centroid of the hyperellipsoid
        ...
        if show and (p == 2 or p == 3):
            MathHelper._plot(P, hypervolume, saxes, center, R, p_val, units, ax)
